#!/usr/bin/env python
"""Generic GraphReduce implementation of rel-trial/study-outcome."""
...
def run_rel_trial_study_outcome(
    ...
    return run_generic_rel_trial_task("study-outcome", data_dir=data_dir)
...
def main() -> None:
    ...
    print("task:", "study-outcome", flush=True)
