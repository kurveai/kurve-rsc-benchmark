#!/usr/bin/env python
"""Run rel-stack user-badge with RelBench task tables and GraphReduce features."""
...
def main() -> None:
    ...
    print("Running rel-stack user-badge task...", flush=True)

    task, _, train_store, train_cut_date = build_task_split_frame(
        con,
        task_name="user-badge",
        split="train",
        feature_builder=build_user_badge_features,
